        ...
        describe("GDPRUserDefaults") {
            ...
            describe("userConsents") {
                ...
                it("persists the value in the local storage") {
                    ...
                    let stored = localStorage.storage[GDPRUserDefaults.GDPR_USER_CONSENTS_KEY] as! SPGDPRConsent
            ...
            describe("dictionaryRepresentation") {
                it("returns a dictionary containing its attributes") {
                    ...
                    expect((dict[GDPRUserDefaults.GDPR_USER_CONSENTS_KEY] as? SPGDPRConsent)).to(equal(userConsents))
