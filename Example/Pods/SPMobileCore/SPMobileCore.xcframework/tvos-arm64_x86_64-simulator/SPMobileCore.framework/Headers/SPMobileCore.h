...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SPJsonSerializer")))
@interface SPMCSPJsonSerializer : SPMCBase <SPMCKotlinx_serialization_coreKSerializer>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)deserializeDecoder:(id<SPMCKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<SPMCKotlinx_serialization_coreEncoder>)encoder value:(NSString *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<SPMCKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end
...
- (instancetype)initWithAuthId:(NSString * _Nullable)authId uuid:(NSString * _Nullable)uuid messageId:(NSString * _Nullable)messageId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> * _Nullable)pubData pmSaveAndExitVariables:(NSString * _Nullable)pmSaveAndExitVariables sendPVData:(BOOL)sendPVData propertyId:(int32_t)propertyId sampleRate:(SPMCFloat * _Nullable)sampleRate includeData:(SPMCIncludeData *)includeData __attribute__((swift_name("init(authId:uuid:messageId:pubData:pmSaveAndExitVariables:sendPVData:propertyId:sampleRate:includeData:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) NSString * _Nullable pmSaveAndExitVariables __attribute__((swift_name("pmSaveAndExitVariables")));
...
- (instancetype)initWithUuid:(NSString *)uuid dateCreated:(NSString * _Nullable)dateCreated consentedAll:(SPMCBoolean * _Nullable)consentedAll rejectedAll:(SPMCBoolean * _Nullable)rejectedAll status:(SPMCCCPAConsentCCPAConsentStatus * _Nullable)status uspstring:(NSString * _Nullable)uspstring gpcEnabled:(SPMCBoolean * _Nullable)gpcEnabled rejectedVendors:(NSArray<NSString *> * _Nullable)rejectedVendors rejectedCategories:(NSArray<NSString *> * _Nullable)rejectedCategories webConsentPayload:(NSString * _Nullable)webConsentPayload gppData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonPrimitive *> *)gppData __attribute__((swift_name("init(uuid:dateCreated:consentedAll:rejectedAll:status:uspstring:gpcEnabled:rejectedVendors:rejectedCategories:webConsentPayload:gppData:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithConsentedAll:(BOOL)consentedAll dateCreated:(NSString * _Nullable)dateCreated expirationDate:(NSString * _Nullable)expirationDate rejectedAll:(BOOL)rejectedAll status:(SPMCCCPAConsentCCPAConsentStatus *)status uspstring:(NSString *)uspstring rejectedVendors:(NSArray<NSString *> *)rejectedVendors rejectedCategories:(NSArray<NSString *> *)rejectedCategories gpcEnabled:(SPMCBoolean * _Nullable)gpcEnabled webConsentPayload:(NSString * _Nullable)webConsentPayload gppData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonPrimitive *> *)gppData __attribute__((swift_name("init(consentedAll:dateCreated:expirationDate:rejectedAll:status:uspstring:rejectedVendors:rejectedCategories:gpcEnabled:webConsentPayload:gppData:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCChoiceAllResponseCCPACompanion *companion __attribute__((swift_name("companion")));
- (SPMCChoiceAllResponseCCPA *)doCopyConsentedAll:(BOOL)consentedAll dateCreated:(NSString * _Nullable)dateCreated expirationDate:(NSString * _Nullable)expirationDate rejectedAll:(BOOL)rejectedAll status:(SPMCCCPAConsentCCPAConsentStatus *)status uspstring:(NSString *)uspstring rejectedVendors:(NSArray<NSString *> *)rejectedVendors rejectedCategories:(NSArray<NSString *> *)rejectedCategories gpcEnabled:(SPMCBoolean * _Nullable)gpcEnabled webConsentPayload:(NSString * _Nullable)webConsentPayload gppData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonPrimitive *> *)gppData __attribute__((swift_name("doCopy(consentedAll:dateCreated:expirationDate:rejectedAll:status:uspstring:rejectedVendors:rejectedCategories:gpcEnabled:webConsentPayload:gppData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="uspString")
*/
...
- (instancetype)initWithUuid:(NSString * _Nullable)uuid consentStatus:(SPMCConsentStatus *)consentStatus consentStrings:(NSArray<SPMCUSNatConsentUSNatConsentSection *> *)consentStrings dateCreated:(NSString * _Nullable)dateCreated expirationDate:(NSString * _Nullable)expirationDate gpcEnabled:(SPMCBoolean * _Nullable)gpcEnabled webConsentPayload:(NSString * _Nullable)webConsentPayload gppData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonPrimitive *> *)gppData userConsents:(SPMCUSNatConsentUSNatUserConsents *)userConsents __attribute__((swift_name("init(uuid:consentStatus:consentStrings:dateCreated:expirationDate:gpcEnabled:webConsentPayload:gppData:userConsents:)"))) __attribute__((objc_designated_initializer));
