...
class SourcePointMetaAppUITests: QuickSpec {
    ...
    override func spec() {
        ...
        fit("Delete Property from property list") {
            ...
            doneButton.tap()
            campaigntableviewcellCell.textFields["targetingKeyTextFieldOutlet"].tap()
            campaigntableviewcellCell.textFields["targetingKeyTextFieldOutlet"].typeText("language")
            doneButton.tap()
            campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].tap()
            campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].typeText("en")
            doneButton.tap()
            campaigntableviewcellCell.staticTexts["Save Campaign"].tap()
            let alertView = self.app.alerts["alertView"].scrollViews.otherElements
            let okButton = alertView.buttons["OK"]
        ...
        fit("Edit Property from property list") {
            ...
            if self.app.propertyItem.exists {
                ...
                doneButton.tap()
                campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].tap()
                campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].typeText("fr")
                doneButton.tap()
                campaigntableviewcellCell.staticTexts["Save Campaign"].tap()
                let alertView = self.app.alerts["alertView"].scrollViews.otherElements
                let okButton = alertView.buttons["OK"]
        ...
        fit("Accept all from German Message") {
            ...
            doneButton.tap()
            campaigntableviewcellCell.textFields["targetingKeyTextFieldOutlet"].tap()
            campaigntableviewcellCell.textFields["targetingKeyTextFieldOutlet"].typeText("messageLanguage")
            doneButton.tap()
            campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].tap()
            campaigntableviewcellCell.textFields["targetingValueTextFieldOutlet"].typeText("german")
            doneButton.tap()
            campaigntableviewcellCell.staticTexts["Save Campaign"].tap()
            let alertView = self.app.alerts["alertView"].scrollViews.otherElements
            let okButton = alertView.buttons["OK"]
