...
class PropertyDetailsStorageCoordinatorTest: XCTestCase {
    ...
    func testAddWebproperty() {
        let propertyDataModel = PropertyDetailsModel(accountId: 22, propertyId: 2372, propertyName: "mobile.demo", campaign: 0, privacyManagerId: "5c0e81b7d74b3c30c6852301", creationTimestamp: Date(), authId: nil, nativeMessage: 0, messageLanguage: "English")
