...
class SourcePointClient: SourcePointProtocol {
    ...
    func reportIdfaStatus(propertyId: Int?, uuid: String?, uuidType: SPCampaignType?, messageId: Int?, idfaStatus: SPIDFAStatus, iosVersion: String, partition_uuid: String?) {
