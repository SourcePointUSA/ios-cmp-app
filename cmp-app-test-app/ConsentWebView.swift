...
class ConsentWebView: UIViewController, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    override func viewDidLoad() {
        ...
        let myURL = URL(string: "http://in-app-messaging.pm.cmp.sp-stage.net/?_sp_cmp_inApp=true&_sp_writeFirstPartyCookies=true")
