...
SWIFT_CLASS("_TtC21ConsentViewController25ClientRequestTimeoutError")
@interface ClientRequestTimeoutError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_CLASS("_TtC21ConsentViewController24InvalidReportActionEvent")
@interface InvalidReportActionEvent : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@end
...
SWIFT_CLASS("_TtC21ConsentViewController38PostingCustomConsentWithoutConsentUUID")
@interface PostingCustomConsentWithoutConsentUUID : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@property (nonatomic) enum SPCampaignType campaignType;
@end
...
SWIFT_CLASS("_TtC21ConsentViewController17ReportActionError")
@interface ReportActionError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
@interface SPConsentManager (SWIFT_EXTENSION(ConsentViewController)) <SPDelegate>
- (void)onSPUIReady:(UIViewController * _Nonnull)controller;
- (void)onSPNativeMessageReady:(SPNativeMessage * _Nonnull)message;
- (void)onAction:(SPAction * _Nonnull)action from:(UIViewController * _Nonnull)controller;
- (void)onSPUIFinished:(UIViewController * _Nonnull)controller;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id consented:(BOOL)consented OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

enum SPGCMDataObjc_ObjcStatus : NSInteger;
SWIFT_CLASS("_TtC21ConsentViewController13SPGCMDataObjc")
@interface SPGCMDataObjc : NSObject
@property (nonatomic, readonly) enum SPGCMDataObjc_ObjcStatus adStorage;
@property (nonatomic, readonly) enum SPGCMDataObjc_ObjcStatus analyticsStorage;
@property (nonatomic, readonly) enum SPGCMDataObjc_ObjcStatus adUserData;
@property (nonatomic, readonly) enum SPGCMDataObjc_ObjcStatus adPersonalization;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, SPGCMDataObjc_ObjcStatus, "ObjcStatus", open) {
  SPGCMDataObjc_ObjcStatusGranted = 0,
  SPGCMDataObjc_ObjcStatusDenied = 1,
  SPGCMDataObjc_ObjcStatusUnset = 2,
};
...
@interface SPGDPRConsent (SWIFT_EXTENSION(ConsentViewController))
@property (nonatomic, readonly, strong) SPGCMDataObjc * _Nullable objcGoogleConsentMode;
@end
...
typedef SWIFT_ENUM(NSInteger, SPMessageLanguage, open) {
  SPMessageLanguageAlbanian = 0,
  SPMessageLanguageArabic = 1,
  SPMessageLanguageBasque = 2,
  SPMessageLanguageBosnian_Latin = 3,
  SPMessageLanguageBulgarian = 4,
  SPMessageLanguageCatalan = 5,
  SPMessageLanguageChinese_Simplified = 6,
  SPMessageLanguageChinese_Traditional = 7,
  SPMessageLanguageCroatian = 8,
  SPMessageLanguageCzech = 9,
  SPMessageLanguageDanish = 10,
  SPMessageLanguageDutch = 11,
  SPMessageLanguageEnglish = 12,
  SPMessageLanguageEstonian = 13,
  SPMessageLanguageFinnish = 14,
  SPMessageLanguageFrench = 15,
  SPMessageLanguageGalician = 16,
  SPMessageLanguageGeorgian = 17,
  SPMessageLanguageGerman = 18,
  SPMessageLanguageGreek = 19,
  SPMessageLanguageHebrew = 20,
  SPMessageLanguageHindi = 21,
  SPMessageLanguageHungarian = 22,
  SPMessageLanguageIndonesian = 23,
  SPMessageLanguageItalian = 24,
  SPMessageLanguageJapanese = 25,
  SPMessageLanguageKorean = 26,
  SPMessageLanguageLatvian = 27,
  SPMessageLanguageLithuanian = 28,
  SPMessageLanguageMacedonian = 29,
  SPMessageLanguageMalay = 30,
  SPMessageLanguageMaltese = 31,
  SPMessageLanguageNorwegian = 32,
  SPMessageLanguagePolish = 33,
  SPMessageLanguagePortuguese_Brazil = 34,
  SPMessageLanguagePortuguese_Portugal = 35,
  SPMessageLanguageRomanian = 36,
  SPMessageLanguageRussian = 37,
  SPMessageLanguageSerbian_Cyrillic = 38,
  SPMessageLanguageSerbian_Latin = 39,
  SPMessageLanguageSlovak = 40,
  SPMessageLanguageSlovenian = 41,
  SPMessageLanguageSpanish = 42,
  SPMessageLanguageSwahili = 43,
  SPMessageLanguageSwedish = 44,
  SPMessageLanguageTagalog = 45,
  SPMessageLanguageThai = 46,
  SPMessageLanguageTurkish = 47,
  SPMessageLanguageUkrainian = 48,
  SPMessageLanguageVietnamese = 49,
  SPMessageLanguageWelsh = 50,
  SPMessageLanguageBrowserDefault = 51,
};
...
typedef SWIFT_ENUM(NSInteger, SPOptinalBool, open) {
  SPOptinalBoolYes = 0,
  SPOptinalBoolNo = 1,
...
@class SPUSNatConsent_ConsentString;
...
SWIFT_CLASS_NAMED("ConsentString")
@interface SPUSNatConsent_ConsentString : NSObject
...
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)initWithSectionId:(NSInteger)sectionId sectionName:(NSString * _Nonnull)sectionName consentString:(NSString * _Nonnull)consentString OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class SPUSNatConsent_ObjcStatuses;
@interface SPUSNatConsent (SWIFT_EXTENSION(ConsentViewController))
@property (nonatomic, readonly, strong) SPUSNatConsent_ObjcStatuses * _Nonnull objcStatuses;
@end

SWIFT_CLASS_NAMED("ObjcStatuses")
@interface SPUSNatConsent_ObjcStatuses : NSObject
@property (nonatomic, readonly) BOOL rejectedAny;
@property (nonatomic, readonly) BOOL consentedToAll;
@property (nonatomic, readonly) BOOL consentedToAny;
@property (nonatomic, readonly) BOOL hasConsentData;
@property (nonatomic, readonly) BOOL sellStatus;
@property (nonatomic, readonly) BOOL shareStatus;
@property (nonatomic, readonly) BOOL sensitiveDataStatus;
@property (nonatomic, readonly) BOOL gpcStatus;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
