...
typedef SWIFT_ENUM(NSInteger, SPMessageLanguage, open) {
  SPMessageLanguageArabic = 0,
  SPMessageLanguageBasque = 1,
  SPMessageLanguageBosnian = 2,
  SPMessageLanguageBrowserDefault = 3,
  SPMessageLanguageEnglish = 4,
  SPMessageLanguageBulgarian = 5,
  SPMessageLanguageCatalan = 6,
  SPMessageLanguageChinese = 7,
  SPMessageLanguageCroatian = 8,
  SPMessageLanguageCzech = 9,
  SPMessageLanguageDanish = 10,
  SPMessageLanguageDutch = 11,
  SPMessageLanguageEstonian = 12,
  SPMessageLanguageFinnish = 13,
  SPMessageLanguageFrench = 14,
  SPMessageLanguageGaelic = 15,
  SPMessageLanguageGalician = 16,
  SPMessageLanguageGerman = 17,
  SPMessageLanguageGreek = 18,
  SPMessageLanguageHebrew = 19,
  SPMessageLanguageHungarian = 20,
  SPMessageLanguageIcelandic = 21,
  SPMessageLanguageIndonesian = 22,
  SPMessageLanguageItalian = 23,
  SPMessageLanguageJapanese = 24,
  SPMessageLanguageKorean = 25,
  SPMessageLanguageLatvian = 26,
  SPMessageLanguageLithuanian = 27,
  SPMessageLanguageMacedonian = 28,
  SPMessageLanguageMalay = 29,
  SPMessageLanguageMaltese = 30,
  SPMessageLanguageNorwegian = 31,
  SPMessageLanguagePolish = 32,
  SPMessageLanguagePortuguese = 33,
  SPMessageLanguageRomanian = 34,
  SPMessageLanguageRussian = 35,
  SPMessageLanguageSerbian_Cyrillic = 36,
  SPMessageLanguageSerbian_Latin = 37,
  SPMessageLanguageSlovakian = 38,
  SPMessageLanguageSlovenian = 39,
  SPMessageLanguageSpanish = 40,
  SPMessageLanguageSwedish = 41,
  SPMessageLanguageTagalog = 42,
  SPMessageLanguageTurkish = 43,
};
