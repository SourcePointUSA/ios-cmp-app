...
SWIFT_CLASS("_TtC21ConsentViewController57InvalidResponseCCPAPrivacyManagerViewEndpointMessageError")
@interface InvalidResponseCCPAPrivacyManagerViewEndpointMessageError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_CLASS("_TtC21ConsentViewController46InvalidResponseGetMessagesEndpointMessageError")
@interface InvalidResponseGetMessagesEndpointMessageError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


SWIFT_CLASS("_TtC21ConsentViewController46InvalidResponseMessageCCPAEndpointMessageError")
@interface InvalidResponseMessageCCPAEndpointMessageError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


SWIFT_CLASS("_TtC21ConsentViewController46InvalidResponseMessageGDPREndpointMessageError")
@interface InvalidResponseMessageGDPREndpointMessageError : SPError
@property (nonatomic, readonly, copy) NSString * _Nonnull spCode;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
