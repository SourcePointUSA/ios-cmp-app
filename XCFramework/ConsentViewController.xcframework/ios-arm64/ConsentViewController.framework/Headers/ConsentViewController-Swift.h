...
typedef SWIFT_ENUM(NSInteger, SPMessageLanguage, open) {
  ...
  SPMessageLanguageHebrew = 15,
  SPMessageLanguageHungarian = 16,
  SPMessageLanguageIcelandic = 17,
  SPMessageLanguageIndonesian = 18,
  SPMessageLanguageItalian = 19,
  SPMessageLanguageJapanese = 20,
  SPMessageLanguageKorean = 21,
  SPMessageLanguageLatvian = 22,
  SPMessageLanguageLithuanian = 23,
  SPMessageLanguageMacedonian = 24,
  SPMessageLanguageMalay = 25,
  SPMessageLanguageNorwegian = 26,
  SPMessageLanguagePolish = 27,
  SPMessageLanguagePortuguese = 28,
  SPMessageLanguageRomanian = 29,
  SPMessageLanguageRussian = 30,
  SPMessageLanguageSerbian_Cyrillic = 31,
  SPMessageLanguageSerbian_Latin = 32,
  SPMessageLanguageSlovakian = 33,
  SPMessageLanguageSlovenian = 34,
  SPMessageLanguageSpanish = 35,
  SPMessageLanguageSwedish = 36,
  SPMessageLanguageTagalog = 37,
  SPMessageLanguageTurkish = 38,
};
